        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="phone" name="phone" placeholder="+254712345678" required disabled={loading} />
            </div>
            ...
            <Button type="submit" className="w-full h-11 bg-gradient-to-r from-indigo-600 to-purple-600" disabled={loading}>
              {loading ? (
                <>
